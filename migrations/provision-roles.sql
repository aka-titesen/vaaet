...
REVOKE ALL ON SCHEMA vaaet_raw, vaaet_ml, vaaet_feedback FROM PUBLIC;
REVOKE ALL ON ALL TABLES IN SCHEMA vaaet_raw, vaaet_ml, vaaet_feedback FROM PUBLIC;

GRANT USAGE ON SCHEMA vaaet_raw TO vaaet_collection_role;
...
GRANT USAGE ON SCHEMA vaaet_ml TO vaaet_inference_role;
...
GRANT USAGE ON SCHEMA vaaet_raw, vaaet_ml, vaaet_feedback TO vaaet_training_role;
GRANT SELECT ON ALL TABLES IN SCHEMA vaaet_raw, vaaet_ml, vaaet_feedback TO vaaet_training_role;

GRANT USAGE ON SCHEMA vaaet_ml, vaaet_feedback TO vaaet_reviewer_role;
