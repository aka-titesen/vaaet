"""Tests for vaaet_ml.settings — single source of truth validation."""
...
class TestConstants:
    ...
    def test_temporal_contract(self) -> None:
        from vaaet_ml.settings import CANONICAL_TIMEZONE, TRAFFIC_LOCAL_TIMEZONE
    ...
    def test_n_states(self) -> None:
        from vaaet_ml.settings import N_STATES, STATE_LABELS
    ...
    def test_labeling_thresholds_immutable(self) -> None:
        from vaaet_ml.settings import LABELING_THRESHOLDS
    ...
    def test_db_env_vars(self) -> None:
        from vaaet_ml.settings import DB_ENV_VARS
    ...
    def test_artifact_paths_are_relative(self) -> None:
        ...
        from vaaet_ml.settings import DATA_PROCESSED_DIR, DATA_RAW_DIR, MODEL_DIR
