...
| R-008 | **Incompatibilidad de versiones** de dependencias (TF, YOLO) | Técnico | Media | Moderado | 🟡 Alto | `vaaet-ml/pyproject.toml` con versiones mínimas; CI en múltiples versiones de Python | Pin de versiones exactas en `requirements-lock.txt` |
