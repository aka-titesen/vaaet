...
class TestEstimateSpeed:
    ...
    def test_plausible_speed(self) -> None:
        ...
        # 120 px / 12 px/m / 0,8 s producen aproximadamente 45 km/h.
    ...
    def test_global_motion_compensation(self) -> None:
        ...
        # Compensar movimiento global en igual dirección debe reducir la velocidad.
...
class TestSelectModelVariant:
    ...
    def test_boundary_values(self) -> None:
        assert select_model_variant(300) == "yolo11x"
        assert select_model_variant(301) == "yolo11l"
        assert select_model_variant(1800) == "yolo11l"
        assert select_model_variant(1801) == "yolo11m"
...
class TestSpeedNoiseFloor:
    def test_jitter_below_noise_floor_returns_none(self) -> None:
        ...
        # El desplazamiento ±1 px queda por debajo del piso de ruido de 2 px.
...
class TestSpeedOutlierClamping:
    def test_single_huge_jump_is_clamped(self) -> None:
        ...
        history = deque(pts)
        result = estimate_speed(history, fps=30.0, frame_height=1080)
        # El salto extremo debe descartarse o quedar dentro del límite plausible.
...
class TestSpeedWindowFrames:
    def test_window_limits_positions_used(self) -> None:
        ...
        # La ventana final contiene movimiento; el historial completo, mayormente reposo.
        ...
        # La estimación acotada debe superar a la global al excluir el reposo inicial.
